...
static const yytype_int16 yyrline[] =
{
      ...
      72,    74,    82,    83,    88,   100,   102,   108,   118,   126,
     136,   138,   148,   150,   151,   152,   153,   154,   156,   162,
     169,   170,   172,   178,   182,   188,   193,   195,   201,   209,
     213,   215,   216,   217,   218,   219,   220,   222,   226,   227,
     228,   230,   234,   236,   237,   239,   240,   241,   242,   244,
     252,   253,   255,   266,   268,   275,   282
};
#endif
...
#line 75 "cminus.y"
                         { 
						yyval = newTreeNode(FunctionDecl); yyval->lineno = yyvsp[-4]->lineno; yyval->type = yyvsp[-5]->type;
                              yyval->name = yyvsp[-4]->name;
                              yyval->child[0] = yyvsp[-2]; yyval->child[1]=yyvsp[0];
                              free(yyvsp[-5]); free(yyvsp[-4]);
                         }
#line 1389 "y.tab.c"
    break;
...
#line 103 "cminus.y"
                         {
						yyval = newTreeNode(Params); yyval->lineno = yyvsp[0]->lineno; yyval->type = yyvsp[-1]->type;
...
#line 109 "cminus.y"
                         { 
						yyval = newTreeNode(Params); yyval->lineno = yyvsp[-2]->lineno;
                              if (yyvsp[-3]->type == Void)    yyval->type = VoidArray;
                              else if (yyvsp[-3]->type == Integer)    yyval->type = IntegerArray;
                              else yyval->type = None;
...
#line 119 "cminus.y"
						...
						yyval = newTreeNode(CompoundStmt); 
                              if(yyvsp[-2]==NULL) yyval->child[0] = yyvsp[-1];
                              else {yyval->child[0] = yyvsp[-2]; yyval->child[1] = yyvsp[-1];}
                              if(yyvsp[-1]!= NULL) yyval->type = yyvsp[-1]->type;
                         }
#line 1459 "y.tab.c"
    break;
...
#line 157 "cminus.y"
                                                {
							yyval=newTreeNode(IfStmt); yyval->lineno=yyvsp[-4]->lineno;
                                   yyval->child[0] = yyvsp[-4]; yyval->child[1] = yyvsp[-2]; yyval->child[2]=yyvsp[0];
                                   yyval->flag=TRUE;
						}
#line 1539 "y.tab.c"
    break;
...
#line 163 "cminus.y"
                                                {
							yyval=newTreeNode(IfStmt); yyval->lineno=yyvsp[-2]->lineno;
                                   yyval->child[0]=yyvsp[-2]; yyval->child[1] = yyvsp[0];
                                   yyval->flag=0;
						}
#line 1549 "y.tab.c"
...
#line 173 "cminus.y"
                         { 
						yyval=newTreeNode(WhileStmt); yyval->lineno=yyvsp[-2]->lineno;
                              yyval->child[0] = yyvsp[-2]; yyval->child[1] = yyvsp[0];
                         }
#line 1570 "y.tab.c"
    break;
...
#line 179 "cminus.y"
                                                { 
							yyval=newTreeNode(ReturnStmt); yyval->flag=TRUE;
						}
#line 1578 "y.tab.c"
    break;
...
#line 183 "cminus.y"
                         { 
                              yyval=newTreeNode(ReturnStmt); yyval->flag=0;
                              yyval->child[0] = yyvsp[-1]; yyval->type = yyvsp[-1]->type;
                         }
#line 1587 "y.tab.c"
    break;
...
#line 189 "cminus.y"
                         { 
                              yyval=newTreeNode(AssignExpr); yyval->lineno = yyvsp[-2]->lineno;
                              yyval->child[0] = yyvsp[-2]; yyval->child[1] = yyvsp[0];
                         }
#line 1596 "y.tab.c"
    break;
...
#line 196 "cminus.y"
						...
						yyval=newTreeNode(VarAccessExpr);
                              yyval->lineno = yyvsp[0]->lineno; yyval->name = yyvsp[0]->name;
                              free(yyvsp[0]);
                         }
#line 1612 "y.tab.c"
    break;
...
#line 202 "cminus.y"
                         {
						yyval=newTreeNode(VarAccessExpr);
                              yyval->lineno=yyvsp[-3]->lineno; yyval->name=yyvsp[-3]->name;
...
#line 1687 "y.tab.c"
  ...
  case 49: /* addop: PLUS  */
#line 227 "cminus.y"
                                        { yyval=newTreeNode(BinOpExpr); yyval->lineno = yyvsp[0]->lineno; yyval->opcode = PLUS; }
#line 1693 "y.tab.c"
    break;

  case 50: /* addop: MINUS  */
#line 228 "cminus.y"
                                                { yyval=newTreeNode(BinOpExpr); yyval->lineno = yyvsp[0]->lineno; yyval->opcode = MINUS; }
#line 1699 "y.tab.c"
    break;
...
#line 1713 "y.tab.c"
  ...
  case 53: /* mulop: TIMES  */
#line 236 "cminus.y"
                            { yyval=newTreeNode(BinOpExpr); yyval->lineno = yyvsp[0]->lineno; yyval->opcode = TIMES; }
#line 1719 "y.tab.c"
    break;

  case 54: /* mulop: OVER  */
#line 237 "cminus.y"
                                                { yyval=newTreeNode(BinOpExpr); yyval->lineno = yyvsp[0]->lineno; yyval->opcode = OVER; }
#line 1725 "y.tab.c"
    break;
...
#line 245 "cminus.y"
                         { 
						yyval=newTreeNode(CallExpr); yyval->lineno = yyvsp[-3]->lineno;
